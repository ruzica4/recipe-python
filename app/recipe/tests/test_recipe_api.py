...
class PrivateRecipeAPITests(TestCase):
    ...
    #     recipe_tags = list(recipe.tags.all().values_list('name', flat=True))
    #     payload_tags = [x['name'] for x in payload['tags']]
    #     for tag in payload_tags:
    #         exists = tag in recipe_tags
